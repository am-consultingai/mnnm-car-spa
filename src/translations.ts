...
export const translations = {
  he: {
    ...
    hero: {
      ...
      sub: 'רחיצה ידנית חיצונית, לא אוטומטית. רק {price}. הזמינו תור היום.',
      subNoPrice: 'רחיצה ידנית חיצונית, לא אוטומטית. הזמינו תור היום.',
    ...
    team: {
      ...
      members: [
        ...
        {
          name: 'נעם',
          desc: 'יזם הפרויקט והמנכ"ל. המוח של הציוד. אם זה מבריק — נעם בחר את החומר.',
        },
        {
          name: 'נטע',
